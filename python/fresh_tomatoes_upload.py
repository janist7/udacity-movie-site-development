...
def open_upload_movies_page():
    # Create or overwrite the output file
    output_file = open('../fresh_tomatoes_upload.html', 'w')

    # Output the file
    output_file.write(template["main_page_head"] + template["main_page_navigation"] + template["upload_movies_form"] + template["main_page_footer"])
    output_file.close()
